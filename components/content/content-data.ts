...
export const contentAccounts: ContentAccount[] = [
  {
    ...
    avatar: '/assets/content/avatar-pet.png',
    ...
    posts: [
      {
        cover: '/assets/content/pet-post-01.png',
        title: '新手养猫好物',
      ...
      {
        cover: '/assets/content/pet-post-02.png',
        title: '趣味种草',
      ...
      {
        cover: '/assets/content/pet-post-03.png',
        title: '养猫日常',
      ...
      {
        cover: '/assets/content/pet-post-04.png',
        title: '猫咪互动日常',
  ...
  },
  {
    ...
    avatar: '/assets/content/avatar-career.png',
    ...
    posts: [
      {
        cover: '/assets/content/career-post-01.png',
        title: '面试经验分享',
      ...
      {
        cover: '/assets/content/career-post-02.png',
        title: '面试经验分享',
      ...
      {
        cover: '/assets/content/career-post-03.png',
        title: 'AI实践干货分享',
      ...
      {
        cover: '/assets/content/career-post-04.png',
        title: '职场成长复盘',
  ...
  },
  {
    ...
    avatar: '/assets/content/avatar-image.png',
    ...
    posts: [
      {
        cover: '/assets/content/image-post-01.png',
        title: '变美经验分享',
      ...
      {
        cover: '/assets/content/image-post-02.png',
        title: '美甲合集分享',
      ...
      {
        cover: '/assets/content/image-post-03.png',
        title: '生活清单分享',
      ...
      {
        cover: '/assets/content/image-post-04.png',
        title: '自我提升记录',
