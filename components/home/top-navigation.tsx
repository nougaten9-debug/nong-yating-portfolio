...
export function TopNavigation({ activeItem, hoveredItem, setHoveredItem }: { activeItem: string; hoveredItem: string | null; setHoveredItem: Dispatch<SetStateAction<string | null>> }) {
